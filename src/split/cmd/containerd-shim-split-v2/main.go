...
import (
	...
	shim "github.com/kata-containers/split/src/runtime/pkg/containerd-shim-v2"
	"github.com/kata-containers/split/src/runtime/pkg/katautils"
	"github.com/kata-containers/split/src/runtime/pkg/types"
)
...
func main() {
	...
	if len(os.Args) == 2 && os.Args[1] == "--version" {
		fmt.Printf("%s containerd shim (Golang): id: %q, version: %s, commit: %v\n", PROJECT, DefaultKataRuntimeName, katautils.VERSION, katautils.COMMIT)
		os.Exit(0)
	}
