...
fn real_main_grpctls() -> Result<(), std::io::Error> {
    ...
    tonic_build::configure()
        ...
        .field_attribute("v6", "#[serde (rename = \"v6\", alias=\"v6\", alias=\"v6\")]")
        .field_attribute("v4", "#[serde (rename = \"v4\")] #[serde (alias=\"v4\")]")
        .type_attribute("IPAddress", "#[derive(serde::Deserialize, serde::Serialize)] #[serde(default)] #[serde (rename = \"IPAddress\")]")
        .field_attribute("IPAddresses", "#[serde (rename = \"IPAddresses\")]")
        .field_attribute("IPFamily", "#[serde (rename = \"IPFamily\")]")
